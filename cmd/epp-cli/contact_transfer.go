...
func runContactTransfer(
	...
	resp, err := client.ContactTransfer(types.ContactTransferRequest{
		ContactID: options.ContactTransferID,
		Operation: options.ContactTransferOperation,
		AuthInfo:  options.ContactTransferAuthInfo,
	})
	if err != nil {
		return err
	}
